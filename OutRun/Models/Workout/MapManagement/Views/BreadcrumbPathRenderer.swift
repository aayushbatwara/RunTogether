...
class BreadcrumbPathRenderer: MKOverlayRenderer {
    ...
    private let crumbs2: BreadcrumbPath

    
    /// This overlay renderer subclass works with the data a `BreadcrumbPath` provides.
    init(crumbPath: BreadcrumbPath, crumbPath2: BreadcrumbPath) {
        crumbs = crumbPath
        crumbs2 = crumbPath2
...
//        return crumbs.pathBounds.intersects(mapRect)
    ...
    */
    ...
    override func draw(_ mapRect: MKMapRect, zoomScale: MKZoomScale, in context: CGContext) {
        ...
        let lineWidth = MKRoadWidthAtZoomScale(zoomScale) * 0.75
